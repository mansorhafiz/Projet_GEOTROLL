/*********************************************************************
 *
 *             Microchip USB C18 Firmware -  CDC Version 1.2
 *
 *********************************************************************
 * FileName:        cdc.h
...
typedef union _CONTROL_SIGNAL_BITMAP
{
    ...
    {
/********************************************************************
Bug Fix: June 19, 2007
*********************************************************************
The original code produces a structure with 4 bytes.
The intention was two bits.
":1" is added to each of the two lines below.

Note that this data structure is only one byte long.
The spec (CDC v1.1 Table 51) uses two bytes but the upper byte is
never used. Therefore it is not implemented here.
********************************************************************/
